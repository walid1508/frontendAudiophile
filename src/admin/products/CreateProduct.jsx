...
const CreateProduct = ({ isModalOpenCreate, setIsModalOpenCreate, fetchProducts, notifyCreate }) => {
    ...
    const isFormValid = () => {
        return name.trim() !== '' && price.trim() !== '' && category.trim() !== '' && description.trim() !== '' && features.trim() !== '' && includes.every(include => include.quantity !== '' && include.item !== '') && gallery.every(g => g !== '');
    };
