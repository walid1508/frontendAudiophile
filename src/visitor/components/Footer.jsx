                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                         <div className="flex justify-center text-white sm:justify-start">
                            <h3 className='text-2xl font-extrabold text-white'>Audiophile</h3>
                        </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    <a className="text-white transition hover:text-gray-700/75"
                                       href="#"> Careers </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li>
                                    <a className="text-white transition hover:text-gray-700/75" href="#"> Web
                                        Design </a>
                                </li>
                                ...
                                <li>
                                    <a className="text-white transition hover:text-gray-700/75" href="#"> Google
                                        Ads </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                >
                                    ...
                                    <address className="-mt-0.5 flex-1 not-italic text-white">
                                        12 Rue Donald, Gatineau, QC, J8T 2W1
                                    </address>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-white">
                            ...
                            <a
                                className="inline-block text-white underline transition hover:text-teal-600/75"
                                href="#"
                            >
                                Terms & Conditions
                            </a>
